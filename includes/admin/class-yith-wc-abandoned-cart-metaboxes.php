...
if ( ! class_exists( 'YITH_WC_RAC_Metaboxes' ) ) {
	...
	class YITH_WC_RAC_Metaboxes {
		...
		public function show_cart_info_metabox( $post ) {
			...
			wc_get_template( 'admin/metabox_cart_info_content.php', $args, '', YITH_YWRAC_TEMPLATE_PATH . '/' );
		...
		public function show_cart_metabox( $post ) {
			...
			if ( $cart_content != '' ) {
				wc_get_template( 'admin/metabox_cart_content.php', array( 'cart_content' => $cart_content ), '', YITH_YWRAC_TEMPLATE_PATH . '/' );
			}
		}
