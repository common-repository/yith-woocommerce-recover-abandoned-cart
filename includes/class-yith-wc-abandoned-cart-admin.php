	...
	class YITH_WC_Recover_Abandoned_Cart_Admin {
		...
		public function register_panel() {
			...
			$args = array(
				...
				'parent_slug'      => '',
				'page_title'       => __( 'YITH WooCommerce Abandoned Cart', 'yith-woocommerce-recover-abandoned-cart' ),
		 ...
		 * @use      plugin_row_meta
		 */
		public function plugin_row_meta( $new_row_meta_args, $plugin_meta, $plugin_file, $plugin_data, $status, $init_file = 'YITH_YWRAC_FREE_INIT' ) {
		...
		public function additional_textarea( $opt ) {
			...
			<tr valign="top">
				...
				<td class="forminp forminp-text">
				  <?php wc_get_template( 'admin/panel/textarea-editor.php', array( 'args' => $opt ), '', YITH_YWRAC_TEMPLATE_PATH . '/' ); ?>
				</td>
			</tr>
			<?php
		}
