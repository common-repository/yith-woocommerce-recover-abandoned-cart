...
if ( ! class_exists( 'YITH_YWRAC_Send_Email' ) ) {
	...
	class YITH_YWRAC_Send_Email extends WC_Email {
		...
		public function __construct() {
			...
			$this->description = _x( 'This is the email sent to the customer from the admin in YITH WooCommerce Recover Abandoned Cart Plugin', 'do not translate plugin name', 'yith-woocommerce-recover-abandoned-cart' );
